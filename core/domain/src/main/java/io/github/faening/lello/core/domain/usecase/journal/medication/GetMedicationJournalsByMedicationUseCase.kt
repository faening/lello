...
class GetMedicationJournalsByMedicationUseCase @Inject constructor(
    private val repository: MedicationJournalRepository<MedicationJournal>
) {
    operator fun invoke(medicationId: Long): Flow<List<MedicationJournal>> {
        return repository.getJournalsByMedication(medicationId)
    }
}